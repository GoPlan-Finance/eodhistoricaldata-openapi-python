    ...
    def __init__(self, api_client=None):
        ...
        def __list_echanges(
            ...
            **kwargs
            ...
            >>> thread = api.list_echanges(async_req=True)
            >>> result = thread.get()
        ...
        self.list_echanges = _Endpoint(
            settings={
                'response_type': ([Exchange],),
                'auth': [
                    'api_token'
                ],
                'endpoint_path': '/exchanges-list',
                'operation_id': 'list_echanges',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        def __list_symbols(
            ...
            **kwargs
            ...
            >>> thread = api.list_symbols(exchange_code, async_req=True)
            >>> result = thread.get()
        ...
        self.list_symbols = _Endpoint(
            settings={
                ...
                'endpoint_path': '/exchange-symbol-list/{exchangeCode}?fmt=json',
